...
namespace CareGuide.Infra.Migrations
{
    ...
    [Migration("20260404174226_AddDoctorSpecialtyTable")]
    partial class AddDoctorSpecialtyTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.Doctor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.DoctorPhone", b =>
                {
                    ...
                    b.ToTable("doctor_phones", (string)null);
                });

            modelBuilder.Entity("CareGuide.Models.Entities.DoctorSpecialty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.PersonDisease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("person_diseases", null, t =>
                        {
                            t.HasCheckConstraint("CK_PersonDisease_DiseaseType", "disease_type IN ('ONC','INF','CHR','GEN','AUT','PSY','TRA','INL','RES','CAR','OTH')");
                        });
                });

            modelBuilder.Entity("CareGuide.Models.Entities.PersonFamilyHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("AgeAtDiagnosis")
                        ...
                        .HasColumnName("age_at_diagnosis");
                    ...
                    b.ToTable("person_family_histories", (string)null);
                });
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.PersonPhone", b =>
                {
                    b.Property<Guid>("PersonId")
                        .HasColumnType("uuid")
                        .HasColumnName("person_id");
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.DoctorPhone", b =>
                {
                    b.HasOne("CareGuide.Models.Entities.Doctor", "Doctor")
                    ...
                    b.HasOne("CareGuide.Models.Entities.Phone", "Phone")
                        .WithMany("DoctorPhones")
                        .HasForeignKey("PhoneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_doctor_phone_phone");
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.DoctorSpecialty", b =>
                {
                    b.HasOne("CareGuide.Models.Entities.Doctor", "Doctor")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_doctor_specialty_doctor");
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.PersonDisease", b =>
                {
                    b.HasOne("CareGuide.Models.Entities.Person", "Person")
                        .WithMany("PersonDiseases")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_person_disease_person");
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.PersonFamilyHistory", b =>
                {
                    b.HasOne("CareGuide.Models.Entities.Person", "Person")
                        .WithMany("PersonFamilyHistories")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_person_family_history_person");
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.PersonPhone", b =>
                {
                    b.HasOne("CareGuide.Models.Entities.Person", "Person")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_person_phone_person");
                    ...
                    b.HasOne("CareGuide.Models.Entities.Phone", "Phone")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_person_phone_phone");
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.User", b =>
                {
                    b.HasOne("CareGuide.Models.Entities.Person", "Person")
                        .WithOne("User")
                        .HasForeignKey("CareGuide.Models.Entities.User", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("CareGuide.Models.Entities.Person", b =>
                {
                    ...
                    b.Navigation("PersonDiseases");

                    b.Navigation("PersonFamilyHistories");
